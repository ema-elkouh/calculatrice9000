...
if __name__ == "__main__": 
    ...
    b_1 = Button(block, text=' 1 ', command=lambda: click(1), height=2, width=10) 
    b_1.grid(row=2, column=0) 
 
    b_2 = Button(block, text=' 2 ', command=lambda: click(2), height=2, width=10) 
    b_2.grid(row=2, column=1) 
 
    b_3 = Button(block, text=' 3 ', command=lambda: click(3), height=2, width=10) 
    b_3.grid(row=2, column=2) 
 
    b_4 = Button(block, text=' 4 ', command=lambda: click(4), height=2, width=10) 
    b_4.grid(row=3, column=0) 
 
    b_5 = Button(block, text=' 5 ', command=lambda: click(5), height=2, width=10) 
    b_5.grid(row=3, column=1) 
 
    b_6 = Button(block, text=' 6 ', command=lambda: click(6), height=2, width=10) 
    b_6.grid(row=3, column=2) 
 
    b_7 = Button(block, text=' 7 ', command=lambda: click(7), height=2, width=10) 
    b_7.grid(row=4, column=0) 
 
    b_8 = Button(block, text=' 8 ', command=lambda: click(8), height=2, width=10) 
    b_8.grid(row=4, column=1) 
 
    b_9 = Button(block, text=' 9 ', command=lambda: click(9), height=2, width=10) 
    b_9.grid(row=4, column=2) 
 
    b_0 = Button(block, text=' 0 ', command=lambda: click(0), height=2, width=10) 
